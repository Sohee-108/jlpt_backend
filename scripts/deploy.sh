...
sudo nohup java -jar jlpt-0.0.1-SNAPSHOT.jar --spring.profiles.active=/home/ubuntu/application-serv.yml > /home/ubuntu/jlpt/nohup.out 2>&1 &
...
# --spring.profiles.active=/home/ubuntu/application-serv.yml
# 환경변수가 안먹혀서 대체함